    ...
    return (
        <div className='min-h-[calc(100vh-10rem)] flex items-center justify-center'>
            <div className='max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg mx-4'>
                ...
                <div className='mt-4'>
                    <form action={login}>
                    <button type='submit' className='w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white transition-colors duration-200 hover:bg-gray-100'>
                ...
                <div className='mt-6 text-sm text-center text-gray-500'>
                    ...
                    By signing in, you agree to our <a href='/terms' className='text-indigo-600 hover:text-indigo-500'>Terms of Service</a>
                    and <a href='/privacy' className='text-indigo-600 hover:text-indigo-500'>Privacy Policy</a>.
                </div>
